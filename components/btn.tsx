...
export function GetStarted() {
  return (
    <Link
      href="./get-started"
      className="get-started flexCenter bg-blue-gradient h-[140px] w-[140px] rounded-full p-[2px]"
    >
      <div className="flexCenter h-full w-full flex-col rounded-full bg-primaryy text-xl font-medium">
